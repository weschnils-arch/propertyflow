...
// ============================================================================
// METAL BUTTON (with color variants including blue/primary)
// ============================================================================
...
const colorVariants: Record<ColorVariant, { outer: string; inner: string; button: string; textColor: string; textShadow: string }> = {
  ...
  primary: {
    outer: "bg-gradient-to-b from-[#1e3a8a] to-[#60a5fa]",
    inner: "bg-gradient-to-b from-[#dbeafe] via-[#1e40af] to-[#bfdbfe]",
    button: "bg-gradient-to-b from-[#60a5fa] to-[#2563eb]",
    textColor: "text-white",
